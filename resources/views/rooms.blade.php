...
<div class="row header-image p-0 m-0">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
    ...
    <a class="dropdown-item" href="{{ url('admin/dashboard') }}" style="background-color: #fff;">
      เข้าสู่หลังบ้าน
    </a>
    @endif
  </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">ກະລຸນາກຣອກລາຍລະອຽດ</h5>
          ...
          <div class="modal-body">
            <form>
              ...
              <label for="funding" class="col-form-label">ໃສ່ເງິນທຶນ:</label>
              <input type="number" id="funding" class="form-control" min="0" data-bind="value:replyNumber">
              </div>
              <div class="form-group">
              <label for="profit" class="col-form-label">ໃສ່ກຳໄລ:</label>
              <input type="number" id="profit" class="form-control" min="0" data-bind="value:replyNumber">
              </div>
            </form>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-info" id="formModalSubmit">ຂ້າມ</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal">ຍົກເລີກ</button>
            <button type="button" class="btn btn-primary" id="formModalSubmit">ຕົກລົງ</button>
          </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="white text-center">
                            <span id="loadingMessage">ກຳລັງວິເຄາະຜົນຫ້ອງ 1 ...</span>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
  ...
  $('#formModal').on('click', '#formModalSubmit', function (e) {
    ...
    $("#loadingMessage").text("ກຳລັງວິເຄາະຜົນຫ້ອງ " + myroomz + " ...");
    $('#loadingModal').modal('show');
    setTimeout(function() {
      hideModal('#loadingModal');
